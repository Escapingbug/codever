...
class MatrixCvp3CrossLanguageFixtureTest {
    ...
    @Test
    fun `opens TypeScript CVP3 key grant and signed project event`() {
        ...
        val opened = MatrixCvp3Protocol.openContent(
        ...
        val event = MatrixCvp3Protocol.verifyGatewayEvent(
            signed,
            gatewayKey,
            WORKSPACE_ID,
            PROJECT_ID,
    ...
    @Test
    fun `TypeScript CVP3 fixture is bound to room certificate and Gateway signature`() {
        assertThrows(IllegalArgumentException::class.java) {
            MatrixCvp3Protocol.openProjectKeyGrant(
        ...
        assertThrows(CodeverSecurityException::class.java) {
            MatrixCvp3Protocol.verifyGatewayEvent(
                signed,
                wrongGateway,
                WORKSPACE_ID,
                PROJECT_ID,
